...
class ActionModel(nn.Module):
    ...
    """
    def __init__(self, input_dim=20, action_dim=19, version=2):
        """
...
# Infrastructure Categories and Items
INFRASTRUCTURE = {
    "Transportation Infrastructure": {
        "Roads & Highways": [
...
def run_simulation():
    ...
    if rank == 0:
        ...
        model = ActionModel(input_dim=20, action_dim=action_dim)  # Updated input_dim and action_dim
        target_model = ActionModel(input_dim=20, action_dim=action_dim)
